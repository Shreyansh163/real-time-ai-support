...
-- CreateIndex
CREATE UNIQUE INDEX "AgentStatus_agentId_key" ON "AgentStatus"("agentId");
...
-- AddForeignKey
ALTER TABLE "AgentStatus" ADD CONSTRAINT "AgentStatus_agentId_fkey" FOREIGN KEY ("agentId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
